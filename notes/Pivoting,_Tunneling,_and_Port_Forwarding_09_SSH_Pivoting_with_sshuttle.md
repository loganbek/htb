<!--
 // Platform: Academy
// URL: https://academy.hackthebox.com/module/158/section/1432
// Platform Version: V1
// Module ID: 158
// Module Name: Pivoting, Tunneling, and Port Forwarding
// Module Difficulty: Medium
// Section ID: 1432
// Section Title: SSH Pivoting with sshuttle
...
**Module Name:** Pivoting, Tunneling, and Port Forwarding **Page Number:** 09
...
``` shell-session
[!bash!]$ nmap -v -sV -p3389 172.16.5.19 -A -Pn
