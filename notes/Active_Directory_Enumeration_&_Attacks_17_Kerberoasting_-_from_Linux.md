<!--
 // Platform: Academy
// URL: https://academy.hackthebox.com/module/143/section/1274
// Platform Version: V1
// Module ID: 143
// Module Name: Active Directory Enumeration & Attacks
// Module Difficulty: Medium
// Section ID: 1274
// Section Title: Kerberoasting - from Linux
...
**Module Name:** Active Directory Enumeration & Attacks **Page Number:** 17
...
``` shell-session
[!bash!]$ sudo python3 -m pip install .
...
![https://academy.hackthebox.com/storage/modules/143/hashcat_tgs.png](https://academy.hackthebox.com/storage/modules/143/hashcat_tgs.png)
