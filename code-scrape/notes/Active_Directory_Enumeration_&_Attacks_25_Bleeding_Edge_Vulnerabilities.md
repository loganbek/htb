<!--
 // Platform: Academy
// URL: https://academy.hackthebox.com/module/143/section/1484
// Platform Version: V1
// Module ID: 143
// Module Name: Active Directory Enumeration & Attacks
// Module Difficulty: Medium
// Section ID: 1484
// Section Title: Bleeding Edge Vulnerabilities
...
**Module Name:** Active Directory Enumeration & Attacks **Page Number:** 25
...
``` shell-session
[!bash!]$ git clone https://github.com/SecureAuthCorp/impacket.git
```
...
``` shell-session
[!bash!]$ git clone https://github.com/Ridter/noPac.git
```
...
![https://academy.hackthebox.com/storage/modules/143/defenderLog.png](https://academy.hackthebox.com/storage/modules/143/defenderLog.png)
...
``` shell-session
[!bash!]$ git clone https://github.com/cube0x0/CVE-2021-1675.git
```
