<!--
 // Platform: Academy
// URL: https://academy.hackthebox.com/module/112/section/1073
// Platform Version: V1
// Module ID: 112
// Module Name: Footprinting
// Module Difficulty: Medium
// Section ID: 1073
// Section Title: IMAP / POP3
...
**Module Name:** Footprinting **Page Number:** 11
...
``` shell-session
ndefstathiou@htb[/htb]$ sudo nmap 10.129.14.128 -sV -p110,143,993,995 -sC
...
``` shell-session
ndefstathiou@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user user:p4ssw0rd
...
``` shell-session
ndefstathiou@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user cry0l1t3:1234 -v
...
``` shell-session
ndefstathiou@htb[/htb]$ openssl s_client -connect 10.129.14.128:pop3s
...
``` shell-session
ndefstathiou@htb[/htb]$ openssl s_client -connect 10.129.14.128:imaps
